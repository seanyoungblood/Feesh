    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        {Object.keys(formData).map((key) => (
          key !== 'spot' && key !== 'time' && key !== 'month' && key !== 'sky' && key !== 'hum' && key !== 'windd' && key !== 'dir' && key !== 'level' && key !== 'color' ? (
          <div key={key}>
            <label>
              {labelMapping[key]}:
              <input
            ...
            <div key={key}>
              <label>
                {labelMapping[key]}:
                <select name={key} value={formData[key]} onChange={handleChange}>
                  <option value="MOD">Select</option>
